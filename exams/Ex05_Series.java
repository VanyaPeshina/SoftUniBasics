...
public class Ex05_Series {
    public static void main(String[] args) {
        ...
        double moneyNeeded = Math.abs(sum - budget);
        if (budget >= sum) {
            System.out.printf("You bought all the series and left with %.2f lv.", moneyNeeded);
        } else {
            System.out.printf("You need %.2f lv. more to buy the series!", moneyNeeded);
        }
    }
}